        ...
        <div className="header-container">
            ...
            <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
                ...
                <ul class="nav flex-column pt-3 pt-md-0">
                    <li class="nav-item"><a class="nav-link d-flex align-items-center"><span class="sidebar-icon"><img src="assets/img/light.svg" height="20" width="20" alt="Rich Logo" /> </span><span class="mt-1 ms-1 sidebar-text">Admin Rihlaty</span></a></li>
